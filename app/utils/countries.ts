...
export const countries: Country[] = [
  // High priority countries (shown first)
  { code: 'US', name: 'United States', dialCode: '+1', flag: '🇺🇸', priority: 1 },
  { code: 'CA', name: 'Canada', dialCode: '+1', flag: '🇨🇦', priority: 2 },
  { code: 'GB', name: 'United Kingdom', dialCode: '+44', flag: '🇬🇧', priority: 3 },
  { code: 'AU', name: 'Australia', dialCode: '+61', flag: '🇦🇺', priority: 4 },

  // All other countries alphabetically by name
  ...
  { code: 'VA', name: 'Vatican City', dialCode: '+39066', flag: '🇻🇦' },
